...
<html>
  <head>
    ...
    <title>A new talent added to Future Starr</title>
    <style type="text/css">
    /* -------------------------------------
        ...
        <td class="container" style="font-family:sans-serif;font-size:14px;vertical-align:top;display:block;max-width:580px;padding:10px;width:580px;Margin:0 auto !important;">
          <div class="content" style="box-sizing:border-box;display:block;Margin:0 auto;max-width:580px;padding:10px;">
            ...
            <table class="main" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;background:#fff;border-radius:3px;width:100%;">
              ...
              @if($username == '')
                <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">Hello, {{$email}}</p>
                @else
                ...
                <!-- <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">Please confirm your email address by clicking the link below.</p> -->
                      <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">A new talent has added to Future starr.</p>
                       @if($productLinks) 
                         <ul>
                          @foreach($productLinks as $value)
                             <li>{{ $value }}</li>
                          @endforeach
                         </ul>
                       @endif
