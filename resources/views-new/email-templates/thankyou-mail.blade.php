          ...
          <div class="content" style="box-sizing:border-box;display:block;Margin:0 auto;max-width:580px;padding:10px;">
            ...
            <table class="main" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;background:#fff;border-radius:3px;width:100%;">
              ...
              <tr>
                ...
                <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">Hello, {{$user_email}}</p>

                <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                  You're now part of a global community of doers. FutureStarr is a marketplace of talented online
                  freelancers who pride themselves on getting it done for you. On time. On budget.
                  Get everything from custom websites to fresh original content,
                  stunning graphics and much more.
                </p>
