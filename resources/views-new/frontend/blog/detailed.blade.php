               ...
               <li>
                  <div class="col-md-12 col-sm-12 blog-rela" style="padding:0px;">
                     <div class="card mb-2">
                        <img style="width: 100%;
                        height: 300px;
                        object-fit: cover;" class="p-4" alt="Blog Image" src="{{asset( !empty($blog->blog_img) && file_exists($blog->blog_img) ? $blog->blog_img:'assets/images/default-ad-banner.png')}}" />
                        <div class="card-body">
            ...
            <div class="display-table width-100">
               <div class="display-table-cell width-100px xs-width-50px text-center vertical-align-top xs-display-block xs-margin-10px-bottom border-all">
                  <a href="javascript::void(0)" target="_blank">
                     ...
                     <img alt="Profile Image" class="rounded-circle width-85 xs-width-100" src="{{ asset($blogComment->getCommentUser->profile_pic) }}">
                     @else 
                     <img alt="Profile Image" class="rounded-circle width-85 xs-width-100" src="{{ asset('assets/images/profile.png') }}">
                     @endif
                  </a>
               </div>
               <div class="border-all padding-20px-left display-table-cell vertical-align-top last-paragraph-no-margin xs-no-padding-left xs-display-block margin-30px-bottom">
                  <a href="javascript::void(0)" class="text-extra-dark-gray text-uppercase alt-font font-weight-600 text-small" target="_blank">
