...
@section('title', $user['username'].' | Future Starr')
@section('content')
<style>
   . ul li {
   color: #6f6f6f;
   ...
   .seller ul.seller_data_left_ul.seller_data_left_ul {
   flex-direction: column;
   }
   .seller ul.seller_data_left_ul li.seller_data_left_li {
   margin-bottom: 10px;
   }
   .pd0 {
   ...
   section.knowledge-section-top.pd0 {
		   ...
		   <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 star-background-image">
		    ...
		    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-8">
				<div class="seller_data_left pt-4 pb-4 right-sec-buyer">	
				  ...
				  <!-- <h3 class="pt-3" style="color:#fff!important">{{ $user['username']}}</h3><br>-->
         ...
         <div class="public-profile-main">
            <div class="seller_data_right pt-4">
               <div class="seller_data_right-inner">
                  ...
                  <h5><i class="fa fa-video-camera" aria-hidden="true"></i><br/><br/>No video available</h5>
                  @endif
               </div>
            </div>
         </div>
         ...
         <div class="modal-content">
            <div class="modal-header">
               ...
               <span style="margin-top:10px;"  class="pull-right">
                  ...
                  <img style="width: 17px !important;
                     height: 20px;
                     border-radius: 0%;
                     object-fit: contain;margin-left: 5px;" alt="commercial Ads" class="hover-images" src="{{ asset('assets/images/rider-green.png') }}">
            ...
            <div class="modal-footer-awards">
               ...
               <div class="pop-content">
                  ...
                  <img alt="public-profile" class="circular img-40" src="{{ !empty($rider->profile_pic) ? asset($rider->profile_pic): asset('assets/images/profile.png')}}">
                  </a>
...
<section class="knowledge-section-top pd0 padding-top-50">
   <div class="container">
      <div class="row"> 
         @if(count($talents) > 0 )  
         <span class="products-similar">Purchase Similar Products</span>
            ...
            <ul id="lightSlider3">
               ...
               $allowedMimeTypes1 = ['audio/mp3', 'audio/mpeg'];
               $allowedMimeTypes2 = ['video/mp4', 'video/mkv', 'video/wav'];
               $contentType = mime_content_type($talent->commercialMedia[0]->image_path);
               @endphp
                  ...
                  <li   style="width: 100% !important;">
                     <div class="col-md-12 col-sm-12 blog-rela" style="padding:0px;">
                        <div class="cards">
                           ...
                           <img src="{{ !empty($talent->commercialMedia[0]->image_path) && file_exists($talent->commercialMedia[0]->image_path) ? asset($talent->commercialMedia[0]->image_path) : url('assets/images/star-logo.png') }}" alt="Star Logo" />
                           @endif
                           ...
                           @endphp
                              ...
                              <video id="my-player" poster="{{asset('assets/images/talent-mall/audio-bg.png')}}" style="width: 100%" controls  controlsList="nodownload">
                           ...
                           $video = explode(".",$talent->commercialMedia[0]->image_path) 
                           @endphp
                           @if(strtolower(end($video)) =="mp4" || strtolower(end($video)) =="wav")
                           <video id="my-player" style="width: 100%" controls  controlsList="nodownload">
                           ...
                           <video id="my-player" poster="{{asset('assets/images/audio-banner.jpg')}}" style="width: 100%" controls  controlsList="nodownload">
...
<section class="knowledge-section-top pd0">
   <div class="container">
      <div class="row">
            ...
            <div class="seller_data_left_ul_main">
               <ul class="seller_data_left_ul">
                  <li class="seller_data_left_li">                           
                     ...
                     <a>Views ({{ $profile_views }})</a>
                  </li>
                  <li class="seller_data_left_li">                           
                     <img alt="SALES" src="{{ asset('assets/images/saler_saler _red_star.png') }}">
                     <a>SALES ({{ getSellerSale($user['id']) }})</a>
                  </li>
                  <li class="seller_data_left_li">                           
                     <img alt="AWARDS" src="{{ asset('assets/images/sales_award_yellow_star.png') }}">
                     <a>AWARDS ({{ getSellerTalentAward($user['user_id'])}})</a>
                  </li>
                  <li class="seller_data_left_li">                          
            ...
            <div class="bio_info">
               ...
               <div class="p-1">
                  <div class="text-center">
                     ...
                     <a type="button" class="btn btn-primary rd"  data-toggle="modal" data-target="#riderModal"> <img style="width: 25px !important;
                        height: 20px;
                        border-radius: 0%;
                        object-fit: contain;margin-left: 5px;" alt="commercial Ads" class="hover-images" src="{{ asset('assets/images/rider-green.png') }}">  Riders</a>
                     @else
                     <button type="button" class="btn btn-primary msgme" data-toggle="modal" data-target="#register_my_model"> Message me</button>
                     <a type="button" class="btn btn-primary rd" data-toggle="modal" data-target="#register_my_model"> <img style="width: 25px !important;
                        height: 20px;
                        border-radius: 0%;
                        object-fit: contain;margin-left: 5px;" alt="commercial Ads" class="hover-images" src="{{ asset('assets/images/rider-green.png') }} ">  Riders</a>
                     @endif
               ...
               <div class="col-md-12">
                  ...
                  <div class="main-sec-listinhg">
                     ...
                     <div class="message-box align-sec">
                        ...
                        @if(!empty($socialbuzzList->product_link))  @endif
                        ...
                        @endif
                        @if(strpos($socialbuzzList->product_img_path, '.mp3') !== false || strpos($socialbuzzList->product_img_path, '.mpeg') !== false)
                           ...
                           <div class="modal-content">
                              <div class="modal-header">
                                 ...
                                 <h5 class="pull-right">
                                    ...
                                    <img alt="commercial Ads" class="hover-images mcycle" src="{{ asset('assets/images/rider-green.png') }}"> <!-- {{ asset('assets/images/rider-green.png') }} http://localhost:8000/assets/images/rider-green.png-->
                  ...
                  @else
                      <h1 class="text-danger text-center" style="margin-top: 5pc; margin-bottom: 5pc;">No Trending available. </h1>
                  @endif  
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      $.getJSON('https://ipapi.co/json/', function(data) {
         ...
         var post_data = {'ip': ip, 'country': country,'pathname': pathname,  "_token": "{{ csrf_token() }}",};
         $.ajax({
            type: 'POST',
