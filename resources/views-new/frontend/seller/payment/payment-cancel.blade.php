...
.star-search-banner {
  ...
  <div class="row">
    <div style="z-index:1;" class="col-sm-12">
      <img class="star-search-banner" src="assets/images/cart/talentmall-payment-error.png"  alt="futurestarr artists"/>
    </div>
    <div style="padding:0px;background: linear-gradient(0deg, #848484, #ffffff);
    margin-top: -29px;
    z-index: 0;" class="col-sm-12">
      <div class="col-sm-12 thx">
        ...
        <p class="about-body lg">
		 <img  src="assets/images/flo.png" width="350px"  alt="futurestarr artists"/>
        </p>
