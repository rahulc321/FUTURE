      ...
      <div class="row talent-mall-ban-pro-raw">
	   ...
	   <div class="col-sm-12 talent-mall-ban-pro-raws-da">
            ...
            <ul class="list-unstyled font-weight-600 text-dark mt-3 talent-mall-category-awards">
               <li><i class="fa fa-trophy aw-tr" aria-hidden="true"></i>&nbsp&nbsp AWARDS ({{ $talentInformation['get_talent_awards_count'] }}) <hr class="hrli"></li>
           ...
           @if(Auth::check()) 
            ...
            <ul class="list-unstyled d-flex">
               ...
               <ul class="extra-small-icon social-icon-style-1 text-small mb-0">
                  <li>
                     <a class="facebook customer share" href="http://www.facebook.com/sharer.php?u={{ Request::url() }}" target="_blank" 
                        ><i class="fa fa-facebook"> </i>
                     </a>
                  </li>
                  <li>
                     <a class="twitter customer share" href="http://twitter.com/share?text=share&url={{ Request::url() }}
                        " target="_blank" >
                     <i class="fa fa-twitter"></i>
                     </a>
                  </li>
                  <!-- <li>
                     <a class="google customer share" href="https://www.instagram.com/?url={{ Request::url() }}" target="_blank" rel="noopener">
                     <i class="fa fa-instagram"></i>
                     </a>
                  </li> -->
                  <li>
                     <a class="linkedin customer share" href="http://www.linkedin.com/shareArticle?mini=true&url={{ Request::url() }}&title=product&summary=product&source=futurestarr.com" target="_blank">
