...
<html>
  <head>
    ...
    <title>FutureStarr - Commercial Ads Plan Notification</title>
    <style type="text/css">
    /* -------------------------------------
        ...
        <td class="container" style="font-family:sans-serif;font-size:14px;vertical-align:top;display:block;max-width:580px;padding:10px;width:580px;Margin:0 auto !important;">
          <div class="content" style="box-sizing:border-box;display:block;Margin:0 auto;max-width:580px;padding:10px;">
            ...
            @if($usr->first_name == '')
                ...
                @else
                <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">Hello, {{$usr->first_name}} {{$usr->last_name}}</p>
                @endif
                                  ...
                                  <tbody>
                                    <tr>
                                      <td style="font-family:sans-serif;font-size:14px;vertical-align:top;background-color:#ffffff;border-radius:5px;text-align:center;background-color:#3498db;"> 
                                        Dear Seller, Your commercial ads plan has been expired.
                                        Please visit your seller account on futurestarr to see all the informations. 
                                        Hope you are enjoying the services on futurestarr platform.
                                        We are here to provide you a best experience in all way.
                                        </td>
                                    </tr>
                                  </tbody>
                                </table>
