...
<html>
  <head>
    ...
    <title>Account Deletion Email</title>
    <style type="text/css">
    /* -------------------------------------
            ...
            <table class="main" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;background:#fff;border-radius:3px;width:100%;">
              ...
              <tr>
                ...
                <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">Hello, Admin</p>
                  @if($account_type == '3')
                  @php $role ='Buyer' @endphp
                  @else
                  @php $role ='Seller' @endphp
                  @endif
                <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">A {{$role}}</b> registred with Future Starr has been deleted the account.</p>
                <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                  @if($account_type == '3')
                      Reason for deleting the account: {{$description}}<br>
                      Email - {{ $email}}<br>
                      Role - {{ 'Buyer' }}<br>
                  @endif
                ...
                <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">A user has deleted the account successfully with the futurestarr. </p>
