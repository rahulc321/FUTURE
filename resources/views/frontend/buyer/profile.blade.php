              ...
              <div class="form-sec">
                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12 form-list">
                   ...
                   <div class="col-md-12 col-sm-12 col-xs-12 form-list">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Last name" name="last_name" value="{{old('last_name', !empty($profileData['last_name'])?$profileData['last_name']:'')}}">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 form-list">
                    <div class="form-group">
                      <label>Email</label>
                      <input type="email" class="form-control" placeholder="email" name="email" value="{{old('email', !empty($profileData['email'])?$profileData['email']:'')}}" readonly="readonly">
                      @if ($errors->has('email'))
                         <span class="invalid-feedback" role="alert">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 form-list">
                    <div class="form-group">
                      <label>Phone</label>
                      <input type="number" class="form-control" min="0" placeholder="Phone" name="phone" value="{{old('phone', !empty($profileData['phone'])?$profileData['phone']:'')}}">
                      @if ($errors->has('phone'))
                         <span class="invalid-feedback" role="alert">
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12 form-list">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" min="0" placeholder="Zip Code"  name="zip_code" value="{{old('zip_code', !empty($profileData['zip_code'])?$profileData['zip_code']:'')}}">
