      ...
      <div class="row">
         <div class="col-md-12 col-sm-12 col-xs-12 display-table page-title-large">
            <div class="display-table-cell vertical-align-middle text-center padding-30px-tb">
               <!-- start page title -->
               <p class="alt-font text-white font-weight-600 mb-2 extra-str">Talent Mall</p>
               <!-- end page title -->
               <!-- start sub title -->
      ...
      <div class="row talent-mall-ban-pro-raw">
	   ...
	   <div class="col-sm-12 talent-mall-ban-pro-raws-da">
            ...
            <ul class="list-unstyled font-weight-600 text-dark mt-3 talent-mall-category-awards">
               <li><i class="fa fa-trophy aw-tr"  style="color:#FFD700;" aria-hidden="true"></i>&nbsp&nbsp AWARDS ({{ $talentInformation['get_talent_awards_count'] }}) <hr class="hrli"></li>
			   
			   
               <li><i class="fa fa-download dow-li" aria-hidden="true"></i>&nbsp&nbsp DOWNLOADS ({{ $talentInformation['get_downloads_count'] }}) <hr class="hrli"></li>
			   
			   <li><img style="max-width:25px;border-radius: 0%;object-fit: contain;" alt="commercial Ads" class="hover-images" src="{{ asset('assets/images/view.png') }}">&nbsp&nbsp VIEWS ({{ $talentInformation['view'] }}) <hr class="hrli"></li>
			   
			    <li class="rider" data-toggle="modal" data-target="#exampleModalLong"><img alt="commercial Ads" class="hover-images" src="{{ asset('assets/images/rider-green.png') }}"> &nbsp&nbsp RIDERS ({{ $talentInformation['get_talent_riders_count'] }}) <hr class="hrli"></li>
            </ul>
            ...
            <div class="user-card">
               <div class="user-info">
                  ...
                  <div class="user-caption">
                     <h4 class="us-name">{{ $talentInformation['getUserData']['username'] }}</h4>
		 ...
		 <div class="col-md-7 product-info-deti1">
		  <h4>{{ $talentInformation['title'] }}</h4>
            <p class="product-info-deti1-pr"><strong>PRICE</strong><strong class="product-info-deti1-pr-price"> :&nbsp;${{ $talentInformation['price'] }}</strong></p>
			 ...
			 <div class="col-md-5 product-info-deti2">
		 ...
		 <div class="col-md-7 product-info-deti-subinfo1">
		   @if(!empty($talentInformation['description']))
            ...
            @endif
            <p class="product-info-deti-subinfo1-by"><strong>BY</strong> : {{ $talentInformation['getUserData']['username'] }}</p>
            ...
            <ul class="list-unstyled d-flex">
               <li>
                  ...
                  <a class="motor-css ot" href="javascript:void(0);" data-toggle="modal" data-target="#register_my_model">
                     ...
                     @endif
                     <span class="badge badge-primary">{{ $talentInformation['get_talent_riders_count'] }}</span>
               </li>
               <li class="ml-3">
               <a class="comment-css" href="javascript:void(0);" data-toggle="modal" data-target="#openComment">
               <i class="fa fa-comment" aria-hidden="true"></i>
               </a> 
               <span class="badge badge-primary">{{  $talentInformation['talent_comments_count']  }}</span>
               </li>
            <!--    <li class="ml-3">
               <a class="comment-css" href="javascript:void(0);" data-toggle="modal" data-target="#openPublicComment">
               <i class="fa fa-comment-alt">Comments</i>
               </a> 
               <span class="badge badge-primary">{{ count($talentInformation->talentRatingComments) }}</span>
               </li> -->
            </ul>
               ...
               <ul class="extra-small-icon social-icon-style-1 text-small mb-0">
                  <li>
                     <a class="facebook customer share" href="{{ $talentInformation->facebookLink }}" target="_blank" 
                        ><i class="fa fa-facebook"> </i>
                     </a>
                  </li>
                  <li>
                     <a class="twitter customer share" href="{{ $talentInformation->twitterLink }}
                        " target="_blank" >
                     <i class="fa fa-twitter"></i>
                     </a>
                  </li>
                  <li>
                     <a class="instagram customer share" href="{{ $talentInformation->instagramLink }}" target="_blank" rel="noopener">
                     <i class="fa fa-instagram"></i>
                     </a>
                  </li> 
                  {{-- <li>
                     <a class="linkedin customer share" href="{{ $talentInformation::url() }}&title=product&summary=product&source=futurestarr.com" target="_blank">
...
<section class="similiar-product-section">
   <div class="container">
      <div class="text-center mb-3 mb-sm-5">
         <h1 class="text-uppercase alt-font text-extra-dark-gray margin-20px-bottom font-weight-700 sm-width-100 xs-width-100 similiar-product-section-pu-items">Purchase Similar Items</h1>
         <span class="d-block separator-line-horrizontal-medium-light2 bg-deep-pink mx-auto width-100px"></span>
      </div>
      @if(count($similarTalent) > 0)
      <div class="filter-content overflow-hidden">
         <ul class="portfolio-grid work-3col gutter-medium hover-option6 lightbox-portfolio" >
            @foreach($similarTalent as $value)
            ...
            <li class="design web photography grid-item wow fadeInUp last-paragraph-no-margin">
               <figure>
                  <div class="portfolio-img bg-extra-dark-gray position-relative text-center overflow-hidden">
                     <a class="cursor" href="{{url('talent-mall/product-info/'.$value->slug)}}">
                        @php $allowedMimeTypes = ['image/jpeg','image/gif','image/png','image/bmp','image/svg+xml']; @endphp
                        @php $allowedMimeTypes1 = ['audio/mp3', 'audio/mpeg']; @endphp
                        @php $allowedMimeTypes2 = ['video/mp4', 'video/mkv', 'video/wav']; @endphp
                        @php $contentType = mime_content_type($value->commercialMedia[0]->image_path); @endphp

                        @if(in_array($contentType, $allowedMimeTypes) )
                           <img src="{{asset($value->commercialMedia[0]->image_path)}}" class="product-img" alt="product-img">
                        @endif

                        @if(in_array($contentType, $allowedMimeTypes1) )
                          @php 
                            $video = explode(".", $value->commercialMedia[0]->image_path) @endphp
                        @if(strtolower(end($video)) =="mp3" || strtolower(end($video)) =="mpeg")
                        <video id="my-player" poster="{{asset('assets/images/talent-mall/audio-bg.png')}}" width="100%" controls>
                           <source src="{{asset($value->commercialMedia[0]->image_path)}}" type="video/mp3">
                           <source src="{{asset($value->commercialMedia[0]->image_path)}}" type="video/ogg">
                           Your browser does not support
                           HTML5 video.
                        </video>
                        @endif
                        @endif
                        @if(in_array($contentType, $allowedMimeTypes2) )
                        @php $video = explode(".",$value->commercialMedia[0]->image_path) @endphp
                        @if(strtolower(end($video)) =="mp4" || strtolower(end($video)) =="ogv")
                        <video id="my-player" width="100%" controls>
                           <source src="{{asset($value->commercialMedia[0]->image_path)}}" type="video/mp4">
                           <source src="{{asset($value->commercialMedia[0]->image_path)}}" type="video/ogg">
                           Your browser does not support
                           HTML5 video.
                        </video>
                        @endif
                        @if(strtolower(end($video)) =="mkv")
                        <video id="my-player" poster="" width="100%" controls>
                           <source src="{{asset($value->sampleMedia[0]->image_path)}}" type="video/x-matroska">
                           <source src="{{asset($value->sampleMedia[0]->image_path)}}" type="video/x-matroska">
                           Your browser does not support
                           HTML5 video.
                        </video>
                     ...
                     <div class="portfolio-hover-main">
                        <div class="portfolio-hover-box">
                           <div class="portfolio-hover-content position-relative text-left">
                              <a href="{{ route('talent.productInfo', $value->id)}}"><span class="line-height-normal font-weight-600 text-small margin-5px-bottom text-extra-dark-gray display-block"> {{ $value->title }}</span></a>
                              <!-- <p class="text-medium-gray text-extra-small mb-0">Branding and Identity</p> -->
                              <p class="d-flex justify-content-between text-primary border-top pt-1 mt-2"><strong>${{$value->price}}</strong> <a href="{{ route('talent.productInfo', $value->slug)}}" class="text-uppercase text-small">View more</a></p>
                              <p class="trophy-cust">
                                 <i class="fa fa-trophy {{ $value->get_talent_awards_count >= 1 ? 'gold' : 'grey' }}" aria-hidden="true"></i>
                                 <i class="fa fa-trophy {{ $value->get_talent_awards_count >= 2 ? 'gold' : 'grey' }}" aria-hidden="true"></i>
                                 <i class="fa fa-trophy {{ $value->get_talent_awards_count >= 3 ? 'gold' : 'grey' }}" aria-hidden="true"></i>
                                 <i class="fa fa-trophy {{ $value->get_talent_awards_count >= 4 ? 'gold' : 'grey' }}" aria-hidden="true"></i>
                                 <i class="fa fa-trophy {{ $value->get_talent_awards_count >= 5 ? 'gold' : 'grey' }}" aria-hidden="true"></i>
                                 <span class="cmt-count">({{$value->get_talent_awards_count}})</span>
                              </p>
                           </div>
                        </div>
                     </div>
            ...
            <div class="modal-content">
               ...
               <div class="modal-footer-awards">
                  <div class="fanbase-background">
                     <h5 style="font-size: 16px;">Fan Base</h5>
                  </div>
                  ...
                  <div {{-- class="pop-content" --}} style="padding-top:10px; padding-bottom: 10px; padding-left:15px;">
                     ...
                     <div class="content-sec-pop">
                        <h6 style="font-size: 14px;"> {{ $fanbase->rideBy['username'] }}</h6>
                     </div>
                  </div>
                  @endforeach
                  @else
...
{{-- Public Comment Model is Start --}}

<div class="social-buzz-modals">
   <div class="modal fade" id="openPublicComment" role="dialog">
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal">&times;</button>
               <h5 class="pull-right" style="margin: 15px 0 0 0;">
                  ...
                  ( {{ count($talentInformation->talentRatingComments)}} )
                  </span>
            ...
            <div class="modal-body">
               @if(count($talentInformation->talentRatingComments) > 0)
               @foreach($talentInformation->talentRatingComments as $comment)

                  @if($comment->commentratingBy['role_id'] = '3')

                     @php $c_p_link=  route('buyer-public-profile', $comment->commentratingBy['public_profile']) @endphp

                  @elseif($comment->commentratingBy['role_id'] = '4')

                     @php $c_p_link=  route('seller-public-profile', $comment->commentratingBy['public_profile']) @endphp
               ...
               <span>
                     ...
                     <div class="col-sm-6 col-md-6 col-xs-6">
                        <div class="fanbase-users">
                           <a target="_blank" href="{{ $c_p_link }}">
                              ...
                              <img  class="circular img-40" src="{{ !empty($comment->commentratingBy['profile_pic']) && file_exists($comment->commentratingBy['profile_pic']) ? asset($comment->commentratingBy['profile_pic']) : asset('assets/images/profile.png')}}">

                           </a>
                           <span style="margin-left: 67px;" class="fanbase-user-name"><b>
                              {{ $comment->commentratingBy['first_name'] }} {{ $comment->commentratingBy['last_name'] }}
                           </b></span>
                        </div>
                     </div>
                  ...
                  <div class="row margin-top">
                     <div class="col-md-offset-2 col-sm-7 col-md-7 col-xs-7">
                        <p>{{ $comment->buyer_comment }} </p>
                     </div>
                     <div class="col-md-3 col-sm-3 col-xs-3">
                     	{{-- Award --}}
		                  <p style="float: right;" class="trophy-cust">
		                     <i class="fa fa-trophy {{ $comment->rating >= 1 ? 'gold' : 'grey' }}" aria-hidden="true"></i>
		                     <i class="fa fa-trophy {{ $comment->rating >= 2 ? 'gold' : 'grey' }}" aria-hidden="true"></i>
		                     <i class="fa fa-trophy {{ $comment->rating >= 3 ? 'gold' : 'grey' }}" aria-hidden="true"></i>
		                     <i class="fa fa-trophy {{ $comment->rating >= 4 ? 'gold' : 'grey' }}" aria-hidden="true"></i>
		                     <i class="fa fa-trophy {{ $comment->rating >= 5 ? 'gold' : 'grey' }}" aria-hidden="true"></i>
		                  </p>
                        {{-- Award --}}
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-sm-6 col-md-6 col-xs-6">
                        <div class="fanbase-users">
                           ...
                           <span style="margin-left: 63px;" class="fanbase-user-name"><b>
            ...
            <div class="modal-content">
               ...
               <div class="modal-footer-awards">
                  ...
                  <div {{-- class="pop-content" --}} style="padding-top:10px; padding-bottom: 10px; padding-left:15px;">
                     ...
                     <div class="content-sec-pop">
                        <h6 style="font-size: 14px;"> {{ $fanbase->awardBy['first_name'] }} {{ $fanbase->awardBy['last_name'] }}</h6>
                     </div>
                  </div>
                  @endforeach
                  @else
                  ...
                  <div class="btn-group btn-icons" role="group">
                     ...
                     <ul class="nav">
                        <li class="list-item-facebook">
                           <a href="http://www.facebook.com/sharer.php?u={{Request::fullUrl()}}&t=product" target="_blank" class="social-btn-facebook btn modal-btn btn-bg customer share">
                           <i class="fa fa-facebook"> </i>
                     ...
                     {{--    https://pinterest.com/pin/create/bookmarklet/?media=[post-img]&url=[post-url]&is_video=[is_video]&description=[post-title]
                        ...
                        <li class="list-item-twitter">
                           <a href="http://twitter.com/share?text=share&url={{Request::fullUrl()}}&is_video={{ $talentInformation['commercialMedia'][0]->image_path }}" target="_blank" class="social-btn-twitter btn modal-btn btn-bg customer share">
                           <i class="fa fa-twitter"></i>
                           <span class="separator"></span> TWITTER</a>
                        </li>
                        <li class="list-item-linkedin">
                           <a href="http://www.linkedin.com/shareArticle?mini=true&url={{Request::fullUrl()}}&title=product&summary=product&source=futurestarr.com" target="_blank" class="social-btn-linkedin btn modal-btn btn-bg customer share">
   ...
   <div class="modal-dialog login-model-sec">
      <div class="modal-content">
         ...
         <div class="modal-body seller-video-modal-x">
            <div>
               <button class="close desk-cls" id="vidstop" data-dismiss="modal" type="button">×</button>
            </div>
...
<script type="text/javascript">
   ...
   */
   ...
   jQuery(document).on('click', '#vidstop', function(){
      console.log('fdshljhjghds');
