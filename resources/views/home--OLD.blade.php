            ...
            <div class="slider-typography text-center">
                <div class="slider-text-middle-main">
                    <div class="slider-text-middle">
                        ...
                        <h2 class="alt-font text-uppercase text-white font-weight-700 mb-2 extra"> THE OFFICIAL <b>TALENT</b> MARKET PLACE</h2>
    ...
    <section class="no-padding wow fadeIn bg-extra-dark-gray" id="services" style="visibility: visible;">
        <div class="container-fluid no-padding">
            <div class="row equalize sm-equalize-auto no-margin n-dark-sec">
                <div class="col-md-6 position-relative sm-height-auto xs-height-350px cover-background  wow slideInLeft" data--duration="900ms" style="background-image: url(&quot;assets/images/1.jpg&quot;); visibility: visible; animation-duration: 900ms;"></div>
                <div class="col-md-6 wow slideInRight" data--duration="900ms" style="visibility: visible; animation-duration: 900ms;">
                    <div class="text-center text-md-left py-4 py-sm-5 px-md-4 p-lg-5 m-lg-5">
                        <div class="mb-3 mb-sm-5">
                            ...
                            <h2 class="text-uppercase alt-font text-light-gray margin-20px-bottom font-weight-700 sm-width-100 xs-width-100 extras">FutureStarr</h2><span class="d-block separator-line-horrizontal-medium-light2 bg-deep-pink mx-auto width-100px mr-md-auto ml-md-0"></span></div>
            ...
            <div class="row">
                ...
                <div class="pl-lg-5 col-md-12 col-lg-7  wow fadeIn" data--delay="0.4s" style="visibility: visible; animation-delay: 0.4s;">
                    <div class="mb-3 mt-5 mt-md-0 mb-sm-5 text-center">
                        <h2 class="text-uppercase alt-font text-extra-dark-gray margin-20px-bottom font-weight-700 sm-width-100 xs-width-100 extras">@lang('home.LETSTART')</h2><span class="separator-line-horrizontal-medium-light2 bg-deep-pink d-block mx-auto width-100px"></span></div>
                    <div class="row">
    ...
    <section class="no-padding  wow fadeIn xs-text-center" style="visibility: visible;">
        <div class="container-fluid no-padding">
            <div class="row no-gutters">
                <div class="d-none d-lg-block col-sm-4 col-xl-3 p-0 cover-background" style="background-image: url(&#39;assets/images/parallax-bg3.jpg&#39;)">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 bg-white text-center text-md-left px-md-4 px-lg-5">
                    <div class="py-4">
                        <h2 class="alt-font font-weight-700 text-extra-dark-gray text-uppercase extras">@lang('home.ABOUT')</h2><span class="d-block separator-line-horrizontal-medium-light2 bg-deep-pink mx-auto width-100px mb-3 mb-md-4 mr-md-auto ml-md-0"></span>
...
<h2 class="text-uppercase alt-font text-white margin-10px-top margin-20px-bottom font-weight-700 sm-width-100 xs-width-100 extras">@lang('home.MARKETPLACE')</h2>
    ...
    <section class=" wow fadeIn hover-option4 blog-post-style3">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <h2 class="text-uppercase alt-font text-extra-dark-gray margin-10px-top margin-20px-bottom font-weight-700 sm-width-100 xs-width-100 extras">Latest Blogs</h2><span class="separator-line-horrizontal-medium-light2 bg-deep-pink display-table margin-auto width-100px"></span></div>
            <div class="row">
            @if($blogs)
                    ...
                    <div class="blog-post bg-light-gray inner-match-height">
                        <div class="blog-post-images overflow-hidden position-relative">
                            <a href="{{ route('blog.detailed',[$blog->getBlogCatagories['slug'], $blog->slug]) }}" href="javascript:void(0);">
                              <img src="{{asset( !empty($blog->blog_img) && file_exists($blog->blog_img) ? $blog->blog_img:'assets/images/default-ad-banner.png')}}" alt="Futurestarr Banner">
