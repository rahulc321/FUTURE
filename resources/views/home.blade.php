...
<style type="text/css">
    .hpfs01{
        background-image: url('/assets/images/homepage-5-slider-img-1.jpg');
    }
    .hpfs02{
        visibility: visible;
    }
    .hpfs03{
        background-image: url('/assets/images/cinematic-portrait-of-handsome-young-woman (1).jpg'); visibility: visible; animation-duration: 900ms;
    }
    .hpfs04{
        visibility: visible; animation-duration: 900ms;
    }
    .hpfs05{
        background-image: url('/assets/images/designer-working-online-K5B663T.jpg')
    }
    .hpfs06{
        visibility: visible; animation-delay: 0.4s;
    }
    .hpfs07{
        background-image: url('/assets/images/parallax-bg2.jpg')
    }
</style>
<div class="home">
    ...
    <section class="no-padding wow fadeIn bg-extra-dark-gray hpfs02" id="services">
        <div class="container-fluid no-padding">
            <div class="row equalize sm-equalize-auto no-margin n-dark-sec">
                <div class="col-md-6 position-relative sm-height-auto xs-height-350px cover-background  wow slideInLeft hpfs03" data--duration="900ms"></div>
                    ...
                    <div class="h-100 blog-post blog-post-style1 xs-text-center bg-white">
                        <div class="blog-post-images overflow-hidden">
                            <a href="{{ route('search.index',$category->slug) }}">
                                <img  alt="{{$category->category_alt}}" src="{{asset('assets/'.$category->catagory_image_path)}}"></a>
                        </div>
                    ...
                    <div class="blog-post bg-light-gray inner-match-height">
                        <div class="blog-post-images overflow-hidden position-relative">
                            <a href="{{ route('blog.detailed',[$blog->getBlogCatagories['slug'], $blog->slug]) }}" href="javascript:void(0);">
                              <img src="{{asset( !empty($blog->blog_img) ? $blog->blog_img:'assets/images/default-ad-banner.png')}}" alt="Blog Media" data-mm="{{ asset($blog->blog_img) }}">
...
<div class="pop-up-after-register" style="display: {{ $display_pop == 'seller' ? 'block' : 'none' }}">
    <div class="after-register seller">
        <div class="pop-img-div">
            <img class="demo-user" src="{{ asset('/assets/images/demo-user-360.png') }}">
        </div>
        <div class="div-text">
...
<div class="pop-up-after-register" style="display: {{ $display_pop == 'buyer' ? 'block' : 'none' }}">
    <div class="after-register buyer">
        <div class="pop-img-div">
            <img class="mobile-cover" src="{{ asset('/assets/images/yellow-mobile-cover.png') }}">
